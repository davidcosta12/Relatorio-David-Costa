...
\thesistitle{Relatório de Estágio} % Your thesis title, this is used in the title, print it elsewhere with \ttitle

\thesisinstitution{Kind Tech} % Where the internship took place, this is used in the title, print it elsewhere with \tinstitution

\thesisacademicyear{2025/2026} % Academic year, e.g. "2024/2025"

\studentname{David Gonçalves Costa} % Your name, this is used in the title page, print it elsewhere with \authorname

\studentnumber{1231072} % Student number, e.g. "1209999"

\supervisor{Filipe Fonseca} % Academic supervisor at ISEP

\externalsupervisor{Humberto Delgado} % External supervisor at the internship institution, if exists; comment this line if does not exist.
